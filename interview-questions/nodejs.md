Question is --> In node js one cluster get the data from database unfornatley cluster dead in node js another involves to get the data databse already get data in server where they can choose
